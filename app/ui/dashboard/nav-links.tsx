...
export default function NavLinks() {
  ...
  //const activeClass = isActive ? "bg-sky-100 text-blue-600" : "";
  // Render the links with the active class applied
  // and the appropriate icon
  // This is a simple example, in a real application you might want to use a more
  // sophisticated method to determine the active link, such as using a state management library
